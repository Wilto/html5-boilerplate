...
(function(win, undefined){
	...
	ModernizrPlus = {
		...
		ieInc : document.getElementById('enhanced-ie'),
		ieDet : ieDetect >= opt.minIE
	};
	ModernizrPlus.enhanced = respond.mediaQueriesSupported || ModernizrPlus.ie || ModernizrPlus.ieDet;

	// If we’re emulating non-MQ browsers for development purposes:
	ModernizrPlus.devMode.basicAssets && head.removeChild( doc.getElementById( "enhanced-css" ) );
	
	/* If they didn't include an IE stylesheet: */
	if ( ModernizrPlus.ieDet ) {
		var oldEl = document.getElementById( 'enhanced-css' ),
			clone = oldEl.cloneNode( false );
